...
export const auditQuotesTable = pgTable(
  ...
  (t) => ({
    ...
    idxOwnerCreated: index('audit_owner_created_idx').on(t.ownerId, t.createdAt),
    idxApiKeyCreated: index('audit_apikey_created_idx').on(t.apiKeyId, t.createdAt),
  })
);
