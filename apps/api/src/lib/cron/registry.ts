...
import {
  ...
  dutiesUkFtaOfficial,
  dutiesUkMfnOfficial,
} from './commands/duties/duties-uk.js';
import {
  dutiesMyAllOfficial,
  dutiesMyFtaOfficial,
  dutiesMyMfnOfficial,
...
import { DUTY_COUNTRY_SCAFFOLD_COMMANDS } from './commands/duties/duties-country-scaffold-commands.js';
...
export const commands: Record<string, Command> = {
  ...
  'import:duties:bn-mfn-official': dutiesBnMfnOfficial,
  ...
  'import:duties:id-all-official': dutiesIdAllOfficial,
  'import:duties:id-fta-official': dutiesIdFtaOfficial,
  'import:duties:id-mfn-official': dutiesIdMfnOfficial,
  'import:duties:jp-all': dutiesJpAll,
  'import:duties:jp-fta': dutiesJpFta,
  'import:duties:jp-mfn': dutiesJpMfn,
  'import:duties:kh-all-official': dutiesKhAllOfficial,
  'import:duties:kh-fta-official': dutiesKhFtaOfficial,
  'import:duties:kh-mfn-official': dutiesKhMfnOfficial,
  ...
  'import:duties:la-all-official': dutiesLaAllOfficial,
  'import:duties:la-fta-official': dutiesLaFtaOfficial,
  'import:duties:la-mfn-official': dutiesLaMfnOfficial,
  'import:duties:mm-all-official': dutiesMmAllOfficial,
  'import:duties:mm-fta-official': dutiesMmFtaOfficial,
  'import:duties:mm-mfn-official': dutiesMmMfnOfficial,
  ...
  'import:duties:ph-all-official': dutiesPhAllOfficial,
  'import:duties:ph-fta-official': dutiesPhFtaOfficial,
  'import:duties:ph-mfn-official': dutiesPhMfnOfficial,
  'import:duties:sg-all-official': dutiesSgAllOfficial,
  'import:duties:sg-fta-official': dutiesSgFtaOfficial,
  'import:duties:sg-mfn-official': dutiesSgMfnOfficial,
  'import:duties:th-all-official': dutiesThAllOfficial,
  'import:duties:th-fta-official': dutiesThFtaOfficial,
  'import:duties:th-mfn-official': dutiesThMfnOfficial,
  'import:duties:uk-all-official': dutiesUkAllOfficial,
  'import:duties:uk-fta-official': dutiesUkFtaOfficial,
  'import:duties:uk-mfn-official': dutiesUkMfnOfficial,
